...
#include "arlo_interfaces/srv/detail/get_robot_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GetRobotPose_Request__ros_msg_type = arlo_interfaces__srv__GetRobotPose_Request;
...
size_t get_serialized_size_arlo_interfaces__srv__GetRobotPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetRobotPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arlo_interfaces__srv__GetRobotPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arlo_interfaces
size_t max_serialized_size_arlo_interfaces__srv__GetRobotPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arlo_interfaces__srv__GetRobotPose_Request;
    is_plain =
      (
...
static size_t _GetRobotPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arlo_interfaces__srv__GetRobotPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, srv, GetRobotPose_Request)() {
...
using _GetRobotPose_Response__ros_msg_type = arlo_interfaces__srv__GetRobotPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arlo_interfaces
size_t get_serialized_size_arlo_interfaces__srv__GetRobotPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetRobotPose_Response__ros_msg_type * ros_message = static_cast<const _GetRobotPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arlo_interfaces__srv__GetRobotPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arlo_interfaces
size_t max_serialized_size_arlo_interfaces__srv__GetRobotPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arlo_interfaces__srv__GetRobotPose_Response;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _GetRobotPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arlo_interfaces__srv__GetRobotPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, srv, GetRobotPose_Response)() {
...
// already included above
// #include "arlo_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "arlo_interfaces/srv/get_robot_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, srv, GetRobotPose)() {
