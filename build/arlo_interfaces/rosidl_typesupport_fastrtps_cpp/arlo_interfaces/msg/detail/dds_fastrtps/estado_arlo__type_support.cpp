...
#include "arlo_interfaces/msg/detail/estado_arlo__rosidl_typesupport_fastrtps_cpp.hpp"
...
// functions for sensor_msgs::msg::LaserScan already declared above
...
cdr_serialize(
  const arlo_interfaces::msg::EstadoArlo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arlo_interfaces::msg::EstadoArlo & ros_message)
{
  // Member: sensor1
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_arlo_interfaces
max_serialized_size_EstadoArlo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arlo_interfaces::msg::EstadoArlo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arlo_interfaces::msg::EstadoArlo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arlo_interfaces::msg::EstadoArlo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstadoArlo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const arlo_interfaces::msg::EstadoArlo *>(
...
static size_t _EstadoArlo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EstadoArlo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EstadoArlo__callbacks = {
  "arlo_interfaces::msg",
  "EstadoArlo",
...
static rosidl_message_type_support_t _EstadoArlo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstadoArlo__callbacks,
...
{
  return &arlo_interfaces::msg::typesupport_fastrtps_cpp::_EstadoArlo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arlo_interfaces, msg, EstadoArlo)() {
  return &arlo_interfaces::msg::typesupport_fastrtps_cpp::_EstadoArlo__handle;
}
