...
#include "arlo_interfaces/msg/detail/mates_odom__rosidl_typesupport_fastrtps_c.h"
...
using _MatesOdom__ros_msg_type = arlo_interfaces__msg__MatesOdom;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MatesOdom__ros_msg_type * ros_message = static_cast<const _MatesOdom__ros_msg_type *>(untyped_ros_message);
  // Field name: odom
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MatesOdom__ros_msg_type * ros_message = static_cast<_MatesOdom__ros_msg_type *>(untyped_ros_message);
  // Field name: odom
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_arlo_interfaces__msg__MatesOdom(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MatesOdom__ros_msg_type * ros_message = static_cast<const _MatesOdom__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MatesOdom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arlo_interfaces__msg__MatesOdom(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arlo_interfaces
size_t max_serialized_size_arlo_interfaces__msg__MatesOdom(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arlo_interfaces__msg__MatesOdom;
    is_plain =
      (
...
static size_t _MatesOdom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arlo_interfaces__msg__MatesOdom(
...
static message_type_support_callbacks_t __callbacks_MatesOdom = {
  "arlo_interfaces::msg",
  "MatesOdom",
...
static rosidl_message_type_support_t _MatesOdom__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MatesOdom,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, msg, MatesOdom)() {
  return &_MatesOdom__type_support;
}
