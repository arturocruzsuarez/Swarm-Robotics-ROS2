...
#ifndef ARLO_INTERFACES__SRV__DETAIL__GET_IMPORTANT_WEIGHTS__FUNCTIONS_H_
#define ARLO_INTERFACES__SRV__DETAIL__GET_IMPORTANT_WEIGHTS__FUNCTIONS_H_
...
/// Initialize srv/GetImportantWeights message.
/**
...
/// Finalize srv/GetImportantWeights message.
/**
...
/// Create srv/GetImportantWeights message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * arlo_interfaces__srv__GetImportantWeights_Request__init().
...
/// Destroy srv/GetImportantWeights message.
/**
 * It calls
 * arlo_interfaces__srv__GetImportantWeights_Request__fini()
...
/// Check for srv/GetImportantWeights message equality.
/**
...
/// Copy a srv/GetImportantWeights message.
/**
...
/// Initialize array of srv/GetImportantWeights messages.
/**
...
/// Finalize array of srv/GetImportantWeights messages.
/**
 * It calls
 * arlo_interfaces__srv__GetImportantWeights_Request__fini()
...
/// Create array of srv/GetImportantWeights messages.
/**
 * It allocates the memory for the array and calls
 * arlo_interfaces__srv__GetImportantWeights_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetImportantWeights messages.
/**
 * It calls
 * arlo_interfaces__srv__GetImportantWeights_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetImportantWeights message array equality.
/**
...
/// Copy an array of srv/GetImportantWeights messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * arlo_interfaces__srv__GetImportantWeights_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_interfaces
...
/**
 * It calls
 * arlo_interfaces__srv__GetImportantWeights_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_interfaces
...
/**
 * It allocates the memory for the array and calls
 * arlo_interfaces__srv__GetImportantWeights_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_interfaces
...
/**
 * It calls
 * arlo_interfaces__srv__GetImportantWeights_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARLO_INTERFACES__SRV__DETAIL__GET_IMPORTANT_WEIGHTS__FUNCTIONS_H_
