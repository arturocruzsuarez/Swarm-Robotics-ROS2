...
static const _EvaluateDriver_Request_type_support_symbol_names_t _EvaluateDriver_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, srv, EvaluateDriver_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arlo_interfaces, srv, EvaluateDriver_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arlo_interfaces, srv, EvaluateDriver_Request)() {
  return &::arlo_interfaces::srv::rosidl_typesupport_c::EvaluateDriver_Request_message_type_support_handle;
}
...
static const _EvaluateDriver_Response_type_support_symbol_names_t _EvaluateDriver_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, srv, EvaluateDriver_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arlo_interfaces, srv, EvaluateDriver_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arlo_interfaces, srv, EvaluateDriver_Response)() {
  return &::arlo_interfaces::srv::rosidl_typesupport_c::EvaluateDriver_Response_message_type_support_handle;
}
...
static const _EvaluateDriver_type_support_symbol_names_t _EvaluateDriver_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arlo_interfaces, srv, EvaluateDriver)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arlo_interfaces, srv, EvaluateDriver)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, arlo_interfaces, srv, EvaluateDriver)() {
  return &::arlo_interfaces::srv::rosidl_typesupport_c::EvaluateDriver_service_type_support_handle;
}
